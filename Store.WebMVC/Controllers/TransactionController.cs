...
namespace Store.WebMVC.Controllers
{
    ...
    public class TransactionController : Controller
    {
        ...
        public ActionResult Index(string sortOrder, string searchString)
        {
            ...
            ViewBag.LastNameSortParm = sortOrder == "Last Name" ? "Last_name_desc" : "Last Name";
        ...
        private Product GetProductByID(Transaction transaction)
        {
            ...
            //The quantity to update will need to be whatever is passed in
        ...
        private void UpdateProductQuantity(Product product, int quantityPurchased)
        {
                ...
                product.Quanity -= quantityPurchased;
        }
        ...
        {
            //9 Call the get ProductByID method and pass in transaction
